 ...
 *
 * @param rules List of reaction rules to be checked and triggered.
 * @param activeReactions Set of currently active reactions.
 */
final case class Reactions(
   ...
   * @param newReactions Set of new active reactions to be added.
   * @return A new Reactions instance with the added active reactions.
   */
   ...
   * @return A new Reactions instance with expired reactions removed.
   */
   ...
   * @param currentDay The current simulation day.
   * @return Set of expired ActiveReaction instances.
   */
   ...
   * @param set Set of ActiveReaction instances to remove.
   * @return A new Reactions instance with the specified reactions removed.
   */
