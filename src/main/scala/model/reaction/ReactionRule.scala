 ...
 *
 * @param condition The condition under which the reaction is triggered.
 * @param actionFactory A factory function that produces a ReactionAction for a given node ID.
 * @param duration Optional duration (in days) for which the reaction remains active.
 */
