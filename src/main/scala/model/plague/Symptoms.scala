...
object Symptoms:
  ...
  final val vomiting: Trait = Trait(
    ...
    severity = 1.0,
    cost = 3,
    prerequisites = Set(nausea, pulmonaryEdema, diarrhea)
  )
  ...
  final val pneumonia: Trait = Trait(
    ...
    severity = 2.0,
    cost = 3,
    prerequisites = Set(coughing, pulmonaryEdema, pulmonaryFibrosis)
  )
  ...
  final val sneezing: Trait = Trait(
    ...
    severity = 1.0,
    cost = 5,
    prerequisites = Set(coughing, fever, immuneSuppression)
  )
  ...
  final val sweating: Trait = Trait(
    ...
    severity = 1.0,
    cost = 3,
    prerequisites = Set(rash, fever, skinLesions)
  )
  ...
  final val pulmonaryEdema: Trait = Trait(
    ...
    lethality = 2.0,
    cost = 7,
    prerequisites = Set(vomiting, pneumonia, diarrhea, pulmonaryFibrosis)
  )
  ...
  final val fever: Trait = Trait(
    ...
    lethality = 3.0,
    cost = 9,
    prerequisites = Set(sneezing, sweating, immuneSuppression, skinLesions)
  )
  ...
  final val diarrhea: Trait = Trait(
    ...
    lethality = 1.0,
    cost = 6,
    prerequisites = Set(vomiting, pulmonaryEdema, dysentery)
  )
  ...
  final val pulmonaryFibrosis: Trait = Trait(
    ...
    lethality = 2.0,
    cost = 6,
    prerequisites = Set(pneumonia, pulmonaryEdema, totalOrganFailure)
  )
  ...
  final val immuneSuppression: Trait = Trait(
    ...
    lethality = 4.0,
    cost = 12,
    prerequisites = Set(sneezing, fever, totalOrganFailure)
  )
  ...
  final val totalOrganFailure: Trait = Trait(
    ...
    lethality = 25.0,
    cost = 28,
    prerequisites = Set(pulmonaryFibrosis, immuneSuppression, coma)
  )
  ...
  final val necrosis: Trait = Trait(
    ...
    lethality = 13.0,
    cost = 27,
    prerequisites = Set(skinLesions, hemorrhagicShock)
  )
  ...
  final val coma: Trait = Trait(
    ...
    lethality = 2.0,
    cost = 21,
    prerequisites = Set(paralysis, systematicInfection, totalOrganFailure)
  )
  ...
  final val hemorrhagicShock: Trait = Trait(
    ...
    lethality = 15.0,
    cost = 23,
    prerequisites = Set(internalHemorrhaging, necrosis)
  )
  ...
  final val paralysis: Trait = Trait(
    ...
    lethality = 1.0,
    cost = 10,
    prerequisites = Set(hyperSensitivity, inflammation, coma)
  )
  ...
  final val internalHemorrhaging: Trait = Trait(
    ...
    lethality = 7.0,
    cost = 12,
    prerequisites = Set(hemophilia, tumors, hemorrhagicShock)
  )
  ...
  final val inflammation: Trait = Trait(
    ...
    lethality = 2.0,
    cost = 5,
    prerequisites = Set(paranoia, hyperSensitivity, seizures, paralysis)
  )
  ...
  final val tumors: Trait = Trait(
    ...
    lethality = 4.0,
    cost = 1,
    prerequisites = Set(abscesses, hemophilia, systematicInfection, internalHemorrhaging)
  )
  ...
  final val abscesses: Trait = Trait(
    ...
    severity = 4.0,
    cost = 2,
    prerequisites = Set(cysts, tumors, systematicInfection)
  )
  ...
  final val hemophilia: Trait = Trait(
    ...
    severity = 3.0,
    cost = 3,
    prerequisites = Set(anaemia, tumors, internalHemorrhaging)
  )
  ...
  def custom(name: String,
             ...
             lethality: Double,
             cost: Int,
             prerequisites: Set[Trait]): Trait = Trait(
    name = name,
    category = category,
