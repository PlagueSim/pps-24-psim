...
/**
 * A proxy for the [[WorldBuilder]] that allows mutable updates within a DSL context.
 */
class WorldBuilderProxy
  ...
  /**
   * Sets the movement strategies for the world and updates the underlying builder.
   */
  ...
  /**
   * Builds the [[World]] instance using the current state of the underlying builder.
   */
